...
// 결과값이 나온 반며니, call4() 유형으로 작성한 add의 경우
// console.log() 명령어를 작성해야만 함.
// add() 함수의 경우 내부에 console.log() 실행문이 없기 때문에.
console.log(add(2,3))

console.log(add(add(6,7), add(8,9)))    // 길어지는 경우 가독성을 위해서 엔터 쳐주는 편
// 이상의 코드는 add() 함수를 세 번 호출하는데,
// add(6,7)을 연산하여 결과값을 argument 1번으로,
// add(8,9)를 연산하여 결과값을 qrgument 2번으로 하여
// add(13, 17)을 최종 연산하여 그 결과값을 산출함.

console.log(add(1,2) + 3);

// 한 줄 안에서 값만 반환할 대 -> 실행문이 한 줄 일 때
