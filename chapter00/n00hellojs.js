...
// let b = a;
// console.log(a, b) // 결과값 : 2 2 : 콤마(,)는 출력되지 않는 점에 주목하시면 됩니다.

// java와의 차이점
// a = "안녕하세요";   // 2인 a에 stirng 자료형 대입
...
// 이상의 코드에서 알 수 있는 점은 조건식에 자주 사요오디구요, 비교 연산의 결과값을 산출할 때 많이 사용 됩니다.
...
// console.log(a == c, a != b); // true false
...
// let num05 = 28;
// console.log(
//   "num05는 03의 배수" + (num05 % 3 === 0 ? "입니다." : "가아닙니다.")
// );
// num05는 3의 배수가 아닙니다.
...
/*
원래 이럼
{name: '김철수', age: 25, address: '부산광역시 금정구', married: false}

console.log로 찍고, copy object 사용했더니 key에 "" 붙어있는 걸로 보아 JSON형태로 표기됨.
{
  name: "김철수",
  age: 25,
  address: "부산광역시 금정구",
