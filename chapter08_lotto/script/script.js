...
// // 이상의 코드에서 확인해봤을 때 '오렌지'가 '딸기'로 대체되었음을 확인할 수 있습니다. 즉 index를 한 칸씩 만다거나 하는건 아닙니다.
...
let list = ['agc', 123, true, false, 'ABC'];

list.sort();

console.log(list); // [123, 'ABC', 'agc', false, true]
