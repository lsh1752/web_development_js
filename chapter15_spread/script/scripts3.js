...
//   console.log('성적 우수 학생 명단');

//   for (let i = 0 ; i < topStudents.length; i++) {
//     console.log('성적 우수 학생 : ',topStudents[i]);
//   }
// }
...
console.log(`성적 우수 학생 : ${topStudents.map(topStudent => `${topStudents.name} (${topStudents.grade})`).join(', ')}`);
// topstudents();
// lowstudents();
...
// let upperCasesFruits = fruits.map(fruit => fruit.toUpperCase());

// console.log(upperCasesFruits);
